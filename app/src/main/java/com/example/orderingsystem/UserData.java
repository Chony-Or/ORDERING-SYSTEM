...
public class UserData {
    ...
    public UserData(Integer cust_id, Integer custClass_id, String cust_number, String cust_firstname, String cust_lastname, String cust_houseno, String cust_street, String cust_city) {
        this.cust_id = cust_id;
        this.custClass_id = custClass_id;
        this.cust_number = cust_number;
        this.cust_name = cust_firstname + " " + cust_lastname;
        this.cust_address = cust_houseno + " "+ cust_street +" "+ cust_city;
    }
